...
rollnumber_list = ['21100130', '21100320', '21100170', '21100297', '21100197']
...
for rollnumber in rollnumber_list:
	wav_dir = '/docker/spp2/' + rollnumber
	...
	prus_file = '/docker/spp2/PRUS_' + rollnumber + '.txt'
	l = []
...
with open('data/train/wav.scp', 'w') as fo:
	for r in range(len(rollnumber_list)):
		wav_dir = '/docker/spp2/' + rollnumber_list[r]
		for i in range(600):
